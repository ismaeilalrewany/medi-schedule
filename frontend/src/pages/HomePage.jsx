    ...
    <main className="min-h-screen bg-gradient-to-br from-base-200 to-base-100">
      <div className="container mx-auto px-2">
        <header className="flex flex-col items-center text-center max-w-[700px] mx-auto gap-4 py-16">
          <h1 className="text-2xl sm:text-4xl md:text-6xl font-semibold mb-2 text-neutral">Effortless Appointment Scheduling</h1>
          <p className="text-sm sm:text-[16px] mb-4 text-neutral/80 max-w-[500px] md:max-w-none">MediSchedule helps you connect with top doctors and book your appointments seamlessly. Your health, your schedule, simplified.</p>
          <div>
            <Link to="/patients/appointments" className="btn btn-neutral text-neutral-content btn-sm md:btn-lg">Book New Appointment</Link>
          </div>
        </header>
        ...
        <section className="py-16 text-center">
          <h2 className="text-2xl md:text-3xl font-semibold mb-8 text-neutral">What Our Patients Say</h2>
          <div className="card max-w-2xl mx-auto bg-white shadow">
            <div className="card-body p-4">
              <p className="text-sm sm:text-[16px] italic text-neutral-600">
                "MediSchedule made booking an appointment so simple and stress-free. I found a great doctor and booked a slot within minutes. Highly recommended!"
              </p>
              <p className="mt-2 sm:mt-4 font-semibold text-sm sm:text-[16px] text-neutral-800">- Jane Doe</p>
            </div>
          </div>
        </section>
      </div>
